...
STOCKS_BY_TIER = {
    ...
    #   Utilities      : NEE
    'large': [
        'AAPL', 'MRK', 'MSFT', 'JPM',  'XOM',  'WMT',  'KO',   'IBM',  'GE',
        'GOOGL','AMZN', 'PG',   'CVX',  'HD',   'INTC', 'CSCO',
        'JNJ',  'VZ',   'NEE',  'CAT',
    ],
    ...
    #
    #   Cons Disc      : DECK  SIG   MAT   HOG   ANF   RRGB GT
    #                     M    KSS   AEO   RL    BBY  URBN
    #   Health Care    : XRAY
    #   Energy         : EQT
    #   Materials/Ind  : SON
    'mid':   [
        'DECK', 'SIG',  'MAT',  'HOG',  'ANF',  'RRGB', 'GT',
          'M',  'KSS',  'AEO',  'RL',   'BBY',
        'URBN', 'XRAY', 'EQT',  'SON',
    ],

    # ── Small / distressed cap ───────────────────────────────────────
    ...
    #   IT / Consumer  : GRMN  IMAX  SIRI  XRX   NTGR  HIMX 
    #   Energy         : PLUG  RIG
    #   Cons Disc      : GME   DDS   SCVL  CATO
    #   Health Care    : HCSG
    #   Financials     : NBTB
    #   Materials      : MTRN
    'small': [
        'BB',   'GRMN', 'PLUG', 'RIG',  'IMAX', 'NOK',  'SIRI', 'XRX',
        'GME',  'DDS',  'NTGR', 'HIMX', 'SCVL',
        'CATO', 'HCSG', 'NBTB', 'MTRN',
    ],
}
